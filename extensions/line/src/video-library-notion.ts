...
export type LineVideoLibrary = {
  ...
  markUgcCompleted?(
    ...
    actualCostUsd?: number,
    outcome?: { r2ObjectKey?: string; completedAt?: number },
  ): Promise<void>;
